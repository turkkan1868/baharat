...
const coundet_data: CountDataType[] = [
  { id: 1, number: 200, icon: counter_img_1, text: "+", title: "Ekip üyesi" },
  { id: 2, number: 300, icon: counter_img_2, text: "k+", title: "Kazanılan ödül" },
  { id: 3, number: 100, icon: counter_img_3, text: "+", title: "Tamamlanan proje" },
  { id: 4, number: 900, icon: counter_img_4, text: "+", title: "Müşteri yorumu" },
]
        ...
        <div className="container">
          <div className="counter-version-wrapv1 d-flex align-items-center justify-content-between gap-4">
 ...
 
            {
              style_2 &&
              <>
                <img src="assets/img/element/count-flower-left.png" alt="süsleme" className="cout-flower-left" />
                <img src="assets/img/element/count-flower-right.png" alt="süsleme" className="cout-flower-right" />
              </>
            }
          </div>
        </div>
