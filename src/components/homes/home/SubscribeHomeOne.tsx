              ...
              <div className="row g-4 justify-content-lg-start justify-content-between align-items-end">
                <div className="col-lg-5 col-md-5">
                  <div className="subscribe-thumb">
                    <img src="assets/img/footer/subscribe.png" alt="abone ol görseli" className="w-100" />
                  </div>
                </div>
                ...
                <div className="col-lg-5 col-md-6">
                  <div className="subscribe-content">
                    ...
                    <p>
                      Yeni ürünler, indirimler ve baharat dünyasındaki gelişmelerden haberdar olun
                    </p>
